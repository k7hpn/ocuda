namespace Ocuda.Ops.Models.Keys
{
    ...
    {
        public static readonly string CategoryManagement = nameof(CategoryManagement);
        ...
        public static readonly string EmployeeCardAccess = nameof(EmployeeCardAccess);
        ...
        public static readonly string RenewCardAccess = nameof(RenewCardAccess);
        ...
        public static readonly string ViewAllIncidentReports = nameof(ViewAllIncidentReports);
        public static readonly string WebPageContentManagement = nameof(WebPageContentManagement);
    }
}